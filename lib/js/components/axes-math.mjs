...
export class UIAxesMath extends _BaseContainerComponent {
    constructor(widgetBus, _zones, label, updateDefaultsDependencies) {
        const localZoneElement = widgetBus.domTool.createElement('div', {'class': 'sidebar-group ui_axes_math'})
        ...
        this._initWidgets(collpasibleWidget);
    }
}
