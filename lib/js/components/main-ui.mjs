...
export class MainUIController extends _BaseContainerComponent {
    ...
    constructor(widgetBus) {
        ...
        // [zoneName, dependecyMappings, Constructor, ...args] = widgets[0]
          , generalSettingsContainer = widgetBus.domTool.createElement('div', {'class': 'sidebar-group general-settings'})
          , applicationMetaContainer = widgetBus.domTool.createElement('div', {'class': 'sidebar-group application-meta'})
          ;
        zones.set('general-settings' , generalSettingsContainer);
        zones.set('application-meta' , applicationMetaContainer);
        collapsibleMixin(applicationMetaContainer, '.sidebar-group-title');
