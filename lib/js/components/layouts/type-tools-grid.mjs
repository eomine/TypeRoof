...
class TypeToolsGridController extends _BaseContainerComponent {
    constructor(widgetBus, _zones) {
        const gridManagerContainer = widgetBus.domTool.createElement('div', {'class': 'sidebar-group grid-manager'})
        ...
        super(widgetBus, zones);
        collapsibleMixin(gridManagerContainer, '.sidebar-group-title', true);
