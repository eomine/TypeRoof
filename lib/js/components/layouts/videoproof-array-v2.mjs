...
class UIVideoproofArrayLayers extends _BaseContainerComponent {
    constructor(widgetBus, _zones, label) {
        const localZoneElement = widgetBus.domTool.createElement('div', {'class': 'sidebar-group ui_videoproof_array_layers'})
          ...
          ;
        super(widgetBus, zones);
        collapsibleMixin(localZoneElement, '.sidebar-group-title');
...
class VideoproofArrayV2Controller extends _BaseContainerComponent {
    constructor(widgetBus, _zones) {
        ...
        collapsibleMixin(generalControlsContainer, '.sidebar-group-title');
