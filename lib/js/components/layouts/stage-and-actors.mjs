...
export class UITimeControl extends _BaseContainerComponent{
    constructor(widgetBus, _zones) {
         const localZoneElement = widgetBus.domTool.createElement('div', {'class': 'sidebar-group ui_time_control'})
          , zones = new Map([..._zones, ['local', localZoneElement]])
          ;
        widgetBus.insertElement(localZoneElement);
        super(widgetBus, zones);
        collapsibleMixin(localZoneElement, '.sidebar-group-title', true);
...
class StageAndActorsController extends _BaseContainerComponent {
    constructor(widgetBus, _zones) {
        ...
        const stageManagerContainer = widgetBus.domTool.createElement('div', {'class': 'sidebar-group stage-manager'})
          , propertiesManagerContainer = widgetBus.domTool.createElement('div', {'class': 'sidebar-group properties-manager'})
        ...
        super(widgetBus, zones);
        collapsibleMixin(stageManagerContainer, '.sidebar-group-title');
